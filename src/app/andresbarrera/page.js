...
import { getAndresBarrera } from "@/services/airtable/andresbarrera.service";

const inter = Inter({ subsets: ["latin"] });

export default async function AndresBarrera() {
    const andresData = await getAndresBarrera(); // Fetch data directly in the server component
