...
export default function AndresBarrera({ andresData }) {
    return (
        <main className={`flex min-h-screen flex-col items-center gap-[80px] ${inter.className}`} style={{ background: 'linear-gradient(170deg, rgba(25,53,78,0) 20%, rgba(0,255,255,0.4) 55%, rgba(25,53,78,0)) 80%' }}>
            ...
            <section className="flex flex-col justify-center items-center gap-[40px] mt-[140px]">
                <Image 
                    ...
                    width={300}
                    height={300}
                    style={ {'borderRadius': '150px', 'boxShadow': '0px 20px 30px rgba(0, 0, 0, 0.8)'} }
                />
                    <div className="flex flex-row gap-[20px] justify-center">
                        <img src="/assets/brand/cs-icon-color.svg" alt="CircleSquare Icon" className="w-[60px] h-[60px] md:w-[45px] md:h-[45px] mt-[10px]" />
            ...
            <section className="flex flex-col gap-[30px] m-[50px] mb-[80px]">
                <a href="https://www.circlesquarelabs.com" target="_blank" className="flex flex-wrap flex-row gap-[30px] justify-center items-center hover:bg-white px-[40px] py-[20px] pb-[80px] md:pb-[20px] hover:text-black transition" style={ {'borderRadius': '180px'} }>
                    <div className="relative w-[500px] h-[300px]" >
                        <Image 
                            ...
                            fill
                            objectFit="fit"
                            style={{ 'borderRadius': '10px', 'boxShadow': '0px 20px 30px rgba(0, 0, 0, 0.8)'}}
                        />
                    </div>
                    <div className="flex flex-col w-[480px] gap-[10px]">
